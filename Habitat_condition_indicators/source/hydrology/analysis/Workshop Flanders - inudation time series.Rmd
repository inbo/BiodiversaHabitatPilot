...
Before this workshop, we have already downloaded the datacube for the study area on OpenEO based on Hans's script. The datacube and the other required data can be found here: "./source/hydrology/data/".
