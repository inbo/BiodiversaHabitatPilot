---
title: "Webbekomsbroek_super-resolution_S2DR3"
author: 
...
s2dr3t <- rast("./source/Quantitative_Analysis_Webbekomsbroek/data/processed/S2DR3/S2L2Ax10_T31UFS-1b90bf406-20230301_MS.tif")
if (crs(s2dr3t) != crs(aoi)) {
  s2dr3t <- project(s2dr3t, crs(aoi))
}
stopifnot(
  crs(s2) == crs(aoi),
  crs(s2dr3t) == crs(aoi)
