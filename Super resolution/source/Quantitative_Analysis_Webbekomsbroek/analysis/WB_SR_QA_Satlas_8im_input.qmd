---
title: "Webbekomsbroek_super-resolution_Metria_Satlas_model_8_images_input"
author: 
...
Upload a file of the AOI and the map images that you would like to evaluate (by changing the directories in the code below). The script is currently set up for comparing a deep-resolution image from Metria with an ortho image and a Sentinel-2 scene.
